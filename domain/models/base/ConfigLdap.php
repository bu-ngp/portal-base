 ...
 * @property integer $config_ldap_only_ldap_use
 */
class ConfigLdap extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'config_ldap_only_ldap_use' => Yii::t('domain/config-ldap', 'Config Ldap Only Ldap Use'),
        ];
    }
    ...
    public function edit(ConfigLdapUpdateForm $form)
    {
        ...
        $this->config_ldap_only_ldap_use = $form->config_ldap_only_ldap_use;
    }
    ...
    public static function isOnlyLdapAuthenticate()
    {
        return self::findOne(1)->config_ldap_only_ldap_use;
    }
}
