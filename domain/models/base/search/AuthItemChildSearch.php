...
/**
 * AuthItemChildSearch represents the model behind the search form about `domain\models\base\AuthItemChild`.
 */
class AuthItemChildSearch extends AuthItemChild
{
    ...
    public function searchForAuthItemUpdate($params)
    {
        $query = AuthItemChild::find();
        ...
        $query->andWhere(['parent' => $params['id']]);
