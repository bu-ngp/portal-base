...
return [
    ...
    'Error. Report with id = "{id}" not found in database by current user or session' => 'Ошибка. Отчет с id = "{id}" не найден в базе данных под текущей сессией или пользователем',
