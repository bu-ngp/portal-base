$(document).ready(function () {
    ...
    $grid.find('.pmd-dropdown .dropdown-menu').wrap("<div class='pmd-dropdown-menu-container'></div>");
    $grid.find('.pmd-dropdown .dropdown-menu').before('<div class="pmd-dropdown-menu-bg"></div>');

    var dropdown = $grid.find('.pmd-dropdown');
        ...
        if ($(window).width() < 767) {
            ...
            dropdown.on('show.bs.dropdown', function () {
                ...
                if ($dataSidebar == 'true') {
                    ...
                    $grid.find('.dropdown-menu').removeAttr('style');
                    that.first().stop(true, true).slideDown(300);
                } else {
            ...
            dropdown.on('click', function () {
                ...
                if (hassidebar && !$(this).hasClass("open")) {
                    ...
                    $grid.find('.dropdown-menu').slideUp(300);
