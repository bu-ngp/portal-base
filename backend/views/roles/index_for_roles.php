...
echo GridView::widget([
    ...
    'pjaxSettings' => [
        'options' => [
            'clientOptions' => [
                'url' => new yii\web\JsExpression('function() { return (typeof event.srcElement == "undefined") ? "' . \yii\helpers\Url::to([Yii::$app->urlManager->parseRequest(Yii::$app->request)[0]]) . '" : event.srcElement.href }'), //  \yii\helpers\Url::to(['roles/index-for-roles']),
