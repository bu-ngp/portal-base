...
*<p align="center">*Содержание*</p>*
  ...
  - [Особенности системы](#Особенности-системы)
    - [Особенности гридов системы](#Особенности-гридов-системы)
      ...
      - [Остальные возможсноти](#Остальные-возможсноти)
...
Общие настройки портала содержат следующие настройки:
  ...
  - Электронные адреса администраторов *(Если несколько, перечисляются через запятую. На эти адрса будут слаться системные письма портала, например результат импорта сотрудников с прикрепленным отчетом)*
  - Наименование организации *(Имя организации, будет отображено в подвале портала)*
  - Добавочная информация *(Дополнительная информация, будет отображена под наименованием оганизации в подвале портала)*
...
*<p align="center">Экспорт данных грида в `PDF`</p>*
  ...
  - Файлы отчетов хранятся в [Загрузчике отчетовов](#Затребованные-отчеты), их можно открыть повторно по требованию, без повторного формирования.
  
> Экспорта данных грида можно деактивировать, если в нем нет необходимости. Или активировать экспорт только в определенные форматы.

#### Остальные возможсноти
...
Для этого используется система контроля над процессами `Supervisor`.
  ...
  - Каждый отбработчик отображает прогресс выполнения
...
Для добавления своего приложения необходимо:
  - Добавить Yii2 приложение в папку шаблона [Yii2 Advanced](https://github.com/yiisoft/yii2-app-advanced).
  - Добавить `autoload.php` в index.php файл нового приложения.
